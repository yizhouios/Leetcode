...
public func createListNode(values: [Int]) -> ListNode? {
...
public func createCycleListNode(_ values: [Int], pos: Int) -> ListNode? {
...
/// 依次打印链表节点
public func printListNode(rootNode: ListNode?) {
    if rootNode == nil {
        print("nil")
        return
    }
...
public func createTreeNode(_ list: [Int?]) -> TreeNode? {
...
public func createNode(_ list: [Int?]) -> Node? {
    if list.count < 3 || list[0] == nil {
        return nil
    }
    var queue: [Int?] = list
